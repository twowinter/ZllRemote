/**************************************************************************************************
  Filename:       zll_target.h
  Revised:        $Date: 2013-05-10 15:34:14 -0700 (Fri, 10 May 2013) $
  Revision:       $Revision: 34239 $

  Description:    This file contains the ZCL Light Link (ZLL) Target definitions.
...
/*
 * Initialization for the ZLL Target task
 */
void zllTarget_Init( uint8 task_id );

/*
 * Event Process for the ZLL Target task
 */
...
/*
 * Start the ZLL Target device in the network
 */
...
/*
 * Register an Application's Idnetify callback function
 */
void zllTarget_RegisterIdentifyCB( zclGCB_Identify_t pfnIdentify );

/*
 * Set the router permit join state
 */
