...
#ifndef HW_THERMAL_CTRL_H
#define HW_THERMAL_CTRL_H
 ...
 * CONSTANTS
 */
#define SAMPLELIGHT_THERMAL_THRESHOLD        90
#define SAMPLELIGHT_THERMAL_SAMPLE_INTERVAL  1000
