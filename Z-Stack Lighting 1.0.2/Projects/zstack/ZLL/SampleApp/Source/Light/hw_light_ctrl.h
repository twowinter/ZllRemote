/**************************************************************************************************
  ...
  Description:    Application physical lighting device control and color engine
                  definitions, provided as a source for inspiration.
...
#ifndef HW_LIGHT_CTRL_H
#define HW_LIGHT_CTRL_H
...
#define REFRESH_BYPASS      1
#define REFRESH_RESUME      2
