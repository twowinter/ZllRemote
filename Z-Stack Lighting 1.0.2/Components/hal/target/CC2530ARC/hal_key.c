/**************************************************************************************************
  Filename:       hal_key.c
  Revised:        $Date: 2011-05-10 08:10:41 -0700 (Tue, 10 May 2011) $
  Revision:       $Revision: 25930 $
...
/* The following define which port pins are being used by keypad service */
  #define HAL_KEY_P0_GPIO_PINS  ( HAL_KEY_BIT0 | HAL_KEY_BIT1 | HAL_KEY_BIT6 )
  #define HAL_KEY_P1_GPIO_PINS  ( HAL_KEY_BIT2 | HAL_KEY_BIT3 )
  #define HAL_KEY_P2_GPIO_PINS  ( HAL_KEY_BIT0 )

/* These defines indicate the direction of each pin */
  #define HAL_KEY_P0_INPUT_PINS   ( HAL_KEY_BIT0 | HAL_KEY_BIT1 )
  #define HAL_KEY_P0_OUTPUT_PINS  ( HAL_KEY_BIT6 )
  #define HAL_KEY_P1_INPUT_PINS   ( HAL_KEY_BIT2 )
  #define HAL_KEY_P1_OUTPUT_PINS  ( HAL_KEY_BIT3 )
  #define HAL_KEY_P2_INPUT_PINS   0x00
  #define HAL_KEY_P2_OUTPUT_PINS  ( HAL_KEY_BIT0 )

/* Which pins are used for key interrupts */
  #define HAL_KEY_P0_INTERRUPT_PINS   ( HAL_KEY_BIT0 | HAL_KEY_BIT1 )
  #define HAL_KEY_P1_INTERRUPT_PINS   ( HAL_KEY_BIT2 )

/* Defines for each output pin assignment */
  #define HAL_KEY_SHIFT_REGISTER_CLOCK_PIN  P0_6
  #define HAL_KEY_SHIFT_REGISTER_POWER_PIN  P1_3
  #define HAL_KEY_SHIFT_REGISTER_DATA_PIN   P2_0

#else

/* The following define which port pins are being used by keypad service */
  #define HAL_KEY_P0_GPIO_PINS  ( HAL_KEY_BIT0 | HAL_KEY_BIT1 | HAL_KEY_BIT2 | \
...
/* These defines indicate the direction of each pin */
  ...
  #define HAL_KEY_P2_INPUT_PINS   0x00
  #define HAL_KEY_P2_OUTPUT_PINS  0x00
...
#endif /*#if defined (HAL_BOARD_CC2530ARC_REV_B)*/
...
void HalKeyInit( void )
{
  ...
  P2SEL &= (uint8) ~HAL_KEY_P2_GPIO_PINS;
  ...
  P2DIR |= (uint8) HAL_KEY_P2_OUTPUT_PINS;
  P2DIR &= (uint8) ~HAL_KEY_P2_INPUT_PINS;
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
  ...
  if (Hal_KeyIntEnable)
  {
    ...
    PICTL |= (HAL_KEY_BIT0 | HAL_KEY_BIT1);
...
uint8 HalKeyRead ( void )
{
  ...
  keys |= (P1 & HAL_KEY_P1_INPUT_PINS);
  for (rowcode = 0; rowcode < HAL_KEY_NUM_ROWS; rowcode++)
  {
    if (((1 << rowcode) & keys) == 0)
    {
      break;
   ...
   */
  P2INP |= (HAL_KEY_BIT5 | HAL_KEY_BIT6);
  ...
  for (colcode = 0; colcode < HAL_KEY_NUM_COLUMNS; colcode++)
  {
    // read all rows
    keys = (P0 & HAL_KEY_P0_INPUT_PINS);
    keys |= (P1 & HAL_KEY_P1_INPUT_PINS);
...
void halProcessKeyInterrupt (void)
{
  ...
  if ((P0IFG & HAL_KEY_P0_INTERRUPT_PINS) || (P1IFG & HAL_KEY_P1_INTERRUPT_PINS))
  {
    // Disable interrupt
